...
- **Cool** - They should fulfill the cool-kid's spirit inside the very bottom of my heart.
...
Next.js really gave me a great experience and it might be my top first priority in the future when I want to build either a server-side rendering app or a hybrid static app.
...
I put my server code and database in 2GB droplets. And _I keep facing different server errors I've never met before. Every time I made it work, not in few days, it broke again._

Just want to record errors I met this time:

- cert key net::err_cert_invalid
-
