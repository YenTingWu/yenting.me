---
title: 'Web Security 101 - What is XSS (Cross-Site Scripting)?'
description: 'This is a series of web security articles. In this article, I will explain what I learned about XSS (Cross-Site Scripting)'
