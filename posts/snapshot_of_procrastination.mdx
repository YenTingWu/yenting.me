...
During my self-taught period and my last job, I had learned and experienced UI techniques, and also built a fundamental mindset of how to develop a comprehensive client-side applications. However, when talking about the server side, I had only a slightly understanding. For me, it had always been confusing about the detail of how both sides communicate; been frustrating when cors problems showed up somehow, which took me tons of time to find out all I needed to do is to add a fucking one-line code into the backend codebase and the error solved; been alienating when other people were talking about api gateway, docker and other backend stuff. These experiences cultivated my curiosity and pushed me to learn more things.
